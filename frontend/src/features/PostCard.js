    ...
    return (
        <div className='post-card' onClick={navigateToSinglePost}>
            <div id='post-card-votes'>
                <BsFileArrowUp className='post-card-upvote' size={25} onClick={e => voteClicked(e, 1)}/> 
                {postData.votes} 
                <BsFileArrowDown className='post-card-downvote' size={25} onClick={e => voteClicked(e, -1)}/>
            </div>
